  ...
  return (
    <PaperProvider>
      <View style={styles.container}>
        ...
        {/* Header com gradiente e filtros */}
        <View style={styles.header}>
          <View style={styles.headerContent}>
            <Text style={styles.title}>🎮 RPG Manager</Text>
            <Text style={styles.subtitle}>{characters.length} {characters.length === 1 ? 'herói' : 'heróis'} disponíveis</Text>
          </View>
          ...
          <View style={styles.filterContainer}>
            <View style={styles.filterRow}>
              ...
              <Button 
                mode={filter === 'available' ? 'contained' : 'outlined'}
              ...
              <Button 
                mode={filter === 'recruited' ? 'contained' : 'outlined'}
                onPress={() => setFilter('recruited')}
                style={[styles.filterButton, filter === 'recruited' && styles.activeFilterButton]}
                labelStyle={styles.filterButtonText}
                compact
              >
                Recrutados
            ...
            <View style={styles.classFilterRow}>
              <ScrollView horizontal showsHorizontalScrollIndicator={false} style={styles.classScrollView}>
                <Button 
                  mode={classFilter === null ? 'contained' : 'outlined'}
                  onPress={() => setClassFilter(null)}
                  style={[styles.classFilterButton, classFilter === null && styles.activeClassFilterButton]}
                  labelStyle={styles.classFilterButtonText}
                  compact
                >
                  Todas
                </Button>
                {['Guerreiro', 'Mago', 'Arqueiro', 'Anão', 'Paladino', 'Ladino'].map((classe) => (
                  <Button 
                    key={classe}
                    mode={classFilter === classe ? 'contained' : 'outlined'}
                    onPress={() => setClassFilter(classFilter === classe ? null : classe)}
                    style={[styles.classFilterButton, classFilter === classe && styles.activeClassFilterButton]}
                    labelStyle={styles.classFilterButtonText}
                    compact
                  >
                    {classe}
        ...
        {/* Lista de personagens com estilo completo e filtros */}
